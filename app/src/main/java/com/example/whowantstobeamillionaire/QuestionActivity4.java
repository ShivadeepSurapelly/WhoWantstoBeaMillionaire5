...
public class QuestionActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question4); // Set the layout for this activity
        ...
        String[] options = {"HTML", "CSS", "Java", "XML"};
        String correctOption = options[2]; // "Java" is the correct option
        ...
        findViewById(R.id.confirm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionText == null) {
                    Toast.makeText(QuestionActivity4.this, "Please, select an option", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    if (selectedOptionText.equals(correctOption)) {
                        ...
                        Toast.makeText(QuestionActivity4.this, "Correct! You earned $" + moneyEarned, Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(QuestionActivity4.this, "Incorrect!", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(QuestionActivity4.this, LostActivity.class);
                        startActivity(intent);
                    }
