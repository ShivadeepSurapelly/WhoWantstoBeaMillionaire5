...
public class QuestionActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question9); // Set your activity layout here
        ...
        String question = "What is the capital city of Australia?";
        String[] options = {"Sydney", "Melbourne", "Canberra", "Brisbane"};
        String correctAnswer = options[2]; // "Canberra" is the capital city of Australia
        ...
        findViewById(R.id.confirm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionText == null) {
                    Toast.makeText(QuestionActivity9.this, "Please, select an option", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    if (selectedOptionText.equals(correctAnswer)) {
                        ...
                        Toast.makeText(QuestionActivity9.this, "Correct! You earned $" + moneyEarned, Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(QuestionActivity9.this, "Incorrect!", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(QuestionActivity9.this, LostActivity.class);
                        startActivity(intent);
                    }
