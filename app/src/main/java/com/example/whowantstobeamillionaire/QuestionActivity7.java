...
public class QuestionActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question7); // Set your activity layout here
        ...
        String question = "Which European city is known as the City of Love?";
        String[] options = {"Paris", "Rome", "Venice", "Barcelona"};
        ...
        findViewById(R.id.confirm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionText == null) {
                    Toast.makeText(QuestionActivity7.this, "Please, select an option", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    if (selectedOptionText.equals(correctAnswer)) {
                        ...
                        Toast.makeText(QuestionActivity7.this, "Correct! You earned $" + moneyEarned, Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(QuestionActivity7.this, "Incorrect!", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(QuestionActivity7.this, LostActivity.class);
                        startActivity(intent);
                    }
